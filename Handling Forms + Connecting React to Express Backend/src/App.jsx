    ...
    <>
     ...
     <div className="container">
      <form action="" onSubmit={handleSubmit(onSubmit)}>
        <input placeholder='username' {...register("username", { required: {value: true, message: "This field is empty"}, minLength: {value: 3, message: "Min length required is 3"}, maxLength: {value: 10, message: "Max length required is 10"}})} type="text"  />
